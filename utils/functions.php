...
function isUserLoggedIn(){
    return !empty($_SESSION["email"]) && !empty($_SESSION["idutente"]);
}

function isManagerLoggedIn(){
    return !empty($_SESSION["email"]) && $_SESSION["manager"] == "true";
}

function isAdminLoggedIn(){
    return !empty($_SESSION["email"]) && !empty($_SESSION["admin"]);
}
...
function registerLoggedManager($user){
    $_SESSION = array();
    $_SESSION["email"] = $user["email"];
    $_SESSION["manager"]="true"; 
    $_SESSION["username"] = $user["username"];
    $_SESSION["partitaiva"] = $user["partitaIVA"];
    $_SESSION["ragionesociale"] = $user["ragioneSociale"];
}
